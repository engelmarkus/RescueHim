...
class 'Fenster1' (Window)

function Fenster1:__init()
    Window.__init(self, "Fenster1", Point(100, 100), Size(200, 200))
end

function Fenster1:onShown()
    print "Fenster1 onShown"
end
...
function DasLevel:OnStart()
    ...
    --print(Sdl.loadImage("data/images/rescuehim0.png"))
    --wnd = Fenster1("Der Titel", Point(100, 100), Size(200, 200))
    wnd = Fenster1()
    Sdl.registerWindow(wnd)
end
